  ...
  return (
    <div className="flex flex-col bg-[#1a1a1a] rounded">
      ...
      <div className="flex flex-col gap-2 py-2 px-3">
        ...
        <button className="py-3 flex justify-center items-center gap-1" onClick={() => window.location.href=props.trailer}>
          <img className="h-5" src="https://img.icons8.com/?size=100&id=9978&format=png&color=FFFFFF" alt="" />
