...
const Details: FC<{ movie: Movie, movieCountries: any }> = ({ movie, movieCountries }) => {
  return (
    <div className=" py-5 sm:px-32 md:px-28 lg:px-40">
      <div className=" px-2 flex flex-col gap-2">
        ...
        <div className=" flex px-2 gap-2">
          ...
          <span className=" text-blue-500 text-sm md:text-base">
            {movieCountries.map((countries: any) => {
              return <span key={countries.countryId}>{countries.country.countryName} • </span>;
            })}
          </span>
        </div>
        <hr className="border-gray-400" />
