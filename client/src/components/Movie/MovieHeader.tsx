...
const MovieHeader: FC<{
  ...
  return (
    ...
    <img src="https://wallpapers.com/images/hd/black-blur-background-wz5o9f31ty8ihr5n.jpg" alt="Promo Banner" className="w-full object-cover h-[64]" />
    <div className=" p-4 sm:px-32 md:px-28 lg:px-40 absolute top-0 left-0 w-full">
